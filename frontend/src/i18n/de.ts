...
export const de: Strings = {
  ...
  'dashboard.mentions': 'Erwähnungen',
  'dashboard.follows': 'Follows',
  'dashboard.friends': 'Freundschaften',
  'dashboard.top_entities': 'Top-Entitäten',
  'dashboard.top_authors': 'Top-Autoren',
  'dashboard.health': 'Status',
  'dashboard.latest_ingestion': 'Letzter Import',
  'dashboard.resolution_coverage': 'Auflösungsabdeckung',
  'dashboard.posts_by_platform': 'Beiträge nach Plattform',
  'dashboard.no_data': 'Noch keine Graphdaten vorhanden. Führe einen Import durch, um den Graphen zu befüllen.',
  'dashboard.no_chart_data': 'Keine Plattformdaten',
  'dashboard.loading': 'Graphstatistiken werden geladen…',
}
