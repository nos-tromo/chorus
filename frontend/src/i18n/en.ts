export const en = {
  ...
  'dashboard.top_authors': 'Top authors',
  'dashboard.health': 'Health',
  'dashboard.latest_ingestion': 'Latest ingestion',
  'dashboard.resolution_coverage': 'Resolution coverage',
  'dashboard.posts_by_platform': 'Posts by platform',
  'dashboard.no_data': 'No graph data yet. Run an ingestion to populate the graph.',
  'dashboard.no_chart_data': 'No platform data',
  'dashboard.loading': 'Loading graph stats…',
} as const
